...
public class CrossController {
	...
	private static PersonInfoService personInfoService = new PersonInfoService();
	...
	public String firestationCoverage(@PathVariable("firestation") final String firestation) {
		return firestationCoverageService.getFirestationCoverage(personDTO, fireStationDTO, medicalRecordDTO, firestation);
	}
	...
	public String personInfo(@PathVariable("name") final String name) {
		return personInfoService.getPersonInfo(personDTO, fireStationDTO, medicalRecordDTO, name);
	}
